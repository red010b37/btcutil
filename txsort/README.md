...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/red010b37/btcutil/txsort)
...
```bash
$ go get -u github.com/red010b37/btcutil/txsort
```
